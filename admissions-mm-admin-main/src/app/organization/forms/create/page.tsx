      ...
      <div className="flex flex-col gap-8 p-4 md:p-6 max-w-5xl mx-auto w-full">
        ...
        <div className="text-center space-y-3 max-w-xl mx-auto pt-4">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            Select a pre-built template to save time, or start with a blank form
            to build a unique experience for your institute.
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div
            onClick={() =>
              !(isCreating || isUpdating) && handleSelectTemplate()
            }
