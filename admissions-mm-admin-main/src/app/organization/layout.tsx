...
export default async function OrganizationLayout({ children }: Readonly<{ children: ReactNode }>) {
    ...
    return (
        <SidebarProvider defaultOpen={defaultOpen}>
            <OrganizationSidebar variant={sidebarVariant} collapsible={sidebarCollapsible} />
            <SidebarInset
