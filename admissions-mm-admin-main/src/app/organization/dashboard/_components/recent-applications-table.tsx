...
const paymentStatusStyles: Record<string, string> = {
  Pending:
    "bg-yellow-500/10 text-yellow-700 font-medium px-2.5 py-0.5 rounded-full text-xs border-0",
  Paid: "bg-green-500/10 text-green-700 font-medium px-2.5 py-0.5 rounded-full text-xs border-0",
  Refunded:
    "bg-red-500/10 text-red-700 font-medium px-2.5 py-0.5 rounded-full text-xs border-0",
};
              ...
              paginatedApplications.map((app) => {
                return (
                  ...
                  >
                    ...
                    <TableCell className="py-5 px-6 align-middle">
                      <span className={paymentStatusStyles[app.paymentStatus] ?? "font-medium px-2.5 py-0.5 rounded-full text-xs bg-gray-100 text-gray-600"}>
                        {app.paymentStatus || "—"}
                      </span>
                    </TableCell>
