        ...
        <div className="flex flex-col gap-4 p-4 md:p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-card border border-border rounded-[12px] px-5 py-4 flex items-center gap-4 shadow-sm hover:shadow-md transition-all duration-200">
              ...
              <div className="flex flex-col gap-2 flex-1 min-w-0">
                <span className="text-[28px] font-bold leading-none text-[#0F172A] text-left">{totalCount}</span>
            ...
            <div className="bg-card border border-border rounded-[12px] px-5 py-4 flex items-center gap-4 shadow-sm hover:shadow-md transition-all duration-200">
              ...
              <div className="flex flex-col gap-2 flex-1 min-w-0">
                <span className="text-[28px] font-bold leading-none text-[#0F172A] text-left">{activeCount}</span>
            ...
            <Table>
              <TableHeader className="bg-[#fafafa] border-b border-[#e2e8f0]">
                <TableRow className="hover:bg-transparent border-b border-[#e2e8f0]">
                  <TableHead className="py-[16px] px-[24px] text-[#64748b] text-[12px] font-semibold tracking-[0.6px] uppercase h-auto text-left">
                    MEMBER
                  </TableHead>
                  <TableHead className="py-[16px] px-[24px] text-[#64748b] text-[12px] font-semibold tracking-[0.6px] uppercase h-auto text-left">
                    CONTACT
                        ...
                        <div className="flex justify-end">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-44 z-50">
                              ...
                              >
                                {user.isActive !== false ? <UserX className="size-4" /> : <UserCheck className="size-4" />}
          ...
          {mobileVisibleCount < filteredTeam.length ? (
            <div className="flex lg:hidden flex-col items-center justify-center gap-3 mt-2">
              <Button
                variant="outline"
                className="w-full bg-background hover:bg-muted/50 border-border/80 text-foreground font-medium h-10 shadow-sm cursor-pointer"
          ...
          <div className="bg-white shadow-2xs rounded-xl p-5 md:p-6 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                className="border-[#D4D4D4] rounded-lg h-11 text-sm placeholder:text-slate-400 bg-white"
                required
              />
            </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative flex items-center">
                  ...
                  <Input
                    ...
                    className="border-[#D4D4D4] rounded-lg h-11 pl-10 text-sm placeholder:text-slate-400 bg-white"
                    required
                  />
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <div className="relative flex items-center">
                  <LockIcon className="absolute left-3.5 text-[#64748B] size-4 pointer-events-none" />
                  <Input
                    type="password"
...
// Small helper to replace Lock with LockIcon
function LockIcon(props: React.ComponentProps<typeof UserIcon>) {
  return (
    <svg
