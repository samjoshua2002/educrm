...
import { useCreateOrganization, useUpdateOrganization, useOrganization } from "@/hooks/use-organizations";
...
export default function CreateOrganizationPage() {
  ...
  const { data: existingOrg, isLoading: isLoadingOrg } = useOrganization(id || "");
  const { mutate: createOrg, isPending: isCreating } = useCreateOrganization();
  const { mutate: updateOrg, isPending: isUpdating } = useUpdateOrganization(id || "");
          ...
          {isLoadingOrg && isEdit ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              ...
              <div className="lg:col-span-8 flex flex-col gap-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {isEdit ? "Update the profile information for the organization." : "Enter the basic profile information for the new tenant."}
                    </CardDescription>
                  </CardHeader>
                <CardContent className="grid gap-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Subdomain / Slug</FormLabel>
                          <FormControl>
                            <div className="flex items-center">
                              <span className="bg-muted px-3 py-2 border border-r-0 rounded-l-md text-sm text-muted-foreground select-none">/</span>
                              <Input 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Contact Email</FormLabel>
                          <FormControl>
                            <div className="relative">
                              <Mail className="absolute left-3 top-2.5 h-4 w-4 text-muted-foreground" />
                              <Input className="pl-9" placeholder="admin@org.com" {...field} />
                            </div>
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Contact Phone</FormLabel>
                          <FormControl>
                            <div className="relative">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Primary Address</FormLabel>
                        <FormControl>
                          <div className="relative">
                            <MapPin className="absolute left-3 top-2.5 h-4 w-4 text-muted-foreground" />
                            <Input className="pl-9" placeholder="123 Campus Road, Academic District" {...field} />
                          </div>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Logo URL</FormLabel>
                        <FormControl>
              ...
              <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-900 rounded-lg p-4 flex gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-blue-900 dark:text-blue-100">Tenant Isolation</h4>
                  <p className="text-sm text-blue-800/80 dark:text-blue-200/80 leading-relaxed">
                    {isEdit ? "Updates to the organization will be propagated across their dedicated resources." : "Creating an organization will initialize a private database schema and dedicated storage bucket. The slug will be used as the unique identifier for their access portal."}
                  </p>
                </div>
              </div>
            </div>
                ...
                <CardContent className="grid gap-6">
                  <div className="grid gap-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-col">
                          <FormLabel className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Plan Start Date</FormLabel>
                          <FormControl>
                             <Input 
                              type="date" 
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-col">
                          <FormLabel className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Plan End Date</FormLabel>
                          <FormControl>
                            <Input 
                              type="date" 
                              value={field.value instanceof Date ? field.value.toISOString().split('T')[0] : ""}
