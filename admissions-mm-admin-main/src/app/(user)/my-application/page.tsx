      ...
      <div className="relative flex justify-between items-start">
        ...
        {steps.map((step, idx) => {
          ...
          return (
            ...
            >
              <div
                className={`flex items-center justify-center size-10 rounded-full border-2 transition-all duration-500 ring-4 ring-background shadow-sm ${
                  isActive
              ...
              <div className="mt-4 flex flex-col items-center text-center max-w-[80px]">
                <span
                  className={`text-[12px] font-bold tracking-tight transition-colors ${isActive ? "text-primary" : "text-muted-foreground"}`}
                >
                  {step.title}
                </span>
      ...
      <div className="max-w-[900px] mx-auto py-12 px-6 animate-in fade-in duration-700">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div className="space-y-2">
            <Badge
              variant="outline"
              className="px-3 py-1 text-[10px] font-bold uppercase tracking-widest bg-primary/5 text-primary border-primary/20 rounded-full"
            >
            ...
            <p className="text-muted-foreground text-lg font-medium">
              Please verify all information before finalizing.
            </p>
          </div>
          <Button
            variant="outline"
            size="lg"
            className="rounded-2xl border-dashed h-14 px-8 border-muted-foreground/30 hover:border-primary transition-all"
          ...
          >
            <div className="flex flex-col md:flex-row gap-12">
                ...
                <div className="relative size-44 rounded-[2rem] border-4 border-background bg-muted shadow-2xl overflow-hidden ring-1 ring-muted">
                  {imagePreview ? (
                    ...
                    <div className="w-full h-full flex flex-col items-center justify-center text-muted-foreground/30">
                      ...
                      <span className="text-[9px] mt-2 font-bold tracking-widest">
                        NO PHOTO
                      </span>
                    </div>
                  )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-8 gap-x-12 flex-grow pt-4">
                <PreviewField
                  label="Full Name"
                  value={`${form.getValues("personal.firstName")} ${form.getValues("personal.lastName")}`}
                />
                <PreviewField
                  label="Email ID"
                  value={form.getValues("personal.email")}
                />
                <PreviewField
                  label="Phone No"
                  value={form.getValues("personal.phone")}
                />
                <PreviewField
                  label="Gender"
                  value={form.getValues("personal.gender")}
                />
                <PreviewField
                  label="Date of Birth"
                  value={form.getValues("personal.dob")}
                />
                <PreviewField
                  label="Nationality"
                  value={form.getValues("personal.nationality")}
                />
              </div>
            </div>
          </SectionPreview>
            ...
            >
              <div className="space-y-8">
                <div className="grid grid-cols-2 gap-6 p-6 rounded-3xl bg-primary/5 border border-primary/10 shadow-inner">
                  <PreviewField
                    label="10th Mark (%)"
                    value={`${form.getValues("academic.tenthPercentage")}%`}
                  />
                  <PreviewField
                    label="12th Mark (%)"
                    value={`${form.getValues("academic.twelfthPercentage")}%`}
                  />
                </div>
                <div>
                  <Label className="text-[10px] uppercase font-black text-muted-foreground tracking-[0.2em] mb-4 block opacity-50">
                    Exam Qualification
                  </Label>
                  <div className="flex items-center gap-6">
                    <Badge className="bg-foreground text-background py-1.5 px-4 rounded-xl text-xs font-bold leading-none">
                      {form.getValues("academic.entranceExam")}
                    </Badge>
                    <span className="text-2xl font-black tracking-tighter leading-none">
                      {form.getValues("academic.entranceScore")} SCORED
                    </span>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="space-y-8">
                <div className="grid gap-6">
                  <PreviewField
                    label="Father's Name"
                    value={form.getValues("family.fatherName")}
                  />
                  <PreviewField
                    label="Mother's Name"
                    value={form.getValues("family.motherName")}
                  />
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <PreviewField
                    ...
                    value={
                      form.getValues("family.experience") || "FRESH GRADUATE"
                    }
                  />
                </div>
              </div>
        ...
        <div className="mt-20 flex flex-col sm:flex-row items-center justify-center gap-8">
          ...
          <Button
            size="lg"
            className="h-16 px-20 bg-primary text-primary-foreground font-black text-xl rounded-2xl shadow-[0_20px_40px_-15px_rgba(var(--primary),0.3)] hover:scale-[1.05] active:scale-[0.98] transition-all"
  ...
  return (
    <div className="max-w-[900px] mx-auto py-20 px-6">
      <div className="flex flex-col items-center text-center mb-20 space-y-6">
        <Badge
          variant="secondary"
          className="bg-primary/5 text-primary border-primary/10 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] shadow-sm"
        >
        ...
        <p className="text-muted-foreground text-lg max-w-lg font-medium leading-relaxed opacity-80">
          Begin your academic journey by providing your details. Everything you
          enter is encrypted and secure.
        </p>
      </div>
              ...
              >
                <div className="flex flex-col items-center justify-center p-12 border-2 border-dashed rounded-[3rem] bg-muted/10 hover:bg-primary/5 hover:border-primary/30 transition-all cursor-pointer relative overflow-hidden group">
                  ...
                  >
                    ...
                    <div className="mt-8 space-y-1">
                      <span className="text-sm font-black block text-foreground/80 tracking-tight">
                        Official Portrait
                      </span>
                      <span className="text-[11px] text-muted-foreground font-medium opacity-60">
                        High resolution JPG or PNG only.
                      </span>
                    </div>
                  </label>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-10 mt-12">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-[10px] uppercase font-black tracking-widest opacity-50">
                          First Name
                        </FormLabel>
                        <FormControl>
                          <Input
                            placeholder="John"
                            className="h-14 rounded-2xl bg-background/50 focus:bg-background transition-all border-muted shadow-sm"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Doe"
                            className="h-14 rounded-2xl bg-background/50 focus:bg-background border-muted shadow-sm"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        >
                          <FormControl>
                            <SelectTrigger className="h-14 rounded-2xl bg-background/50 border-muted shadow-sm">
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            type="date"
                            className="h-14 rounded-2xl bg-background/50 border-muted shadow-sm"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
              ...
              >
                <div className="space-y-12">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <FormField
                      control={form.control}
                      name="academic.twelfthPercentage"
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-[10px] uppercase font-black tracking-widest opacity-50">
                            Grade 12 Marks (%)
                  ...
                  <div className="p-10 rounded-[2.5rem] bg-muted/20 border border-muted/50 shadow-inner relative overflow-hidden group">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 relative z-10">
                      <FormField
                        control={form.control}
                        name="academic.entranceExam"
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-[10px] uppercase font-black tracking-widest opacity-60">
                              Examination Board
                            </FormLabel>
                            <Select
                              onValueChange={field.onChange}
                            ...
                            >
                              <FormControl>
                                <SelectTrigger className="h-14 rounded-2xl bg-background border-muted">
                                  <SelectValue />
                                </SelectTrigger>
                              </FormControl>
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                placeholder="00.00"
                                className="h-14 rounded-2xl bg-background border-muted"
                                {...field}
                              />
                            </FormControl>
                          </FormItem>
              ...
              >
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            className="h-14 rounded-2xl border-muted bg-background/50"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                ...
                <div className="mt-10 grid gap-10">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-[10px] uppercase font-black tracking-widest opacity-50 flex items-center gap-2">
                          Professional Experience{" "}
                          <Badge
                            variant="secondary"
                            className="text-[8px] tracking-normal font-bold"
                          >
                            Optional
                          </Badge>
                        </FormLabel>
                        <FormControl>
                          <Input
                            placeholder="Years of exp / Job Title"
                            className="h-14 rounded-2xl border-muted bg-background/50"
                            {...field}
                          />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            className="min-h-[140px] rounded-[1.5rem] border-muted bg-background/50 p-6 leading-relaxed"
            ...
            {step === 4 && (
              ...
              >
                <div className="space-y-10">
                  <FormField
                    control={form.control}
                    name="declaration.motivation"
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-[10px] uppercase font-black tracking-widest opacity-60 leading-normal">
                          What unique value will you bring to our campus and
                          community?
                        </FormLabel>
                        <FormControl>
                          <Textarea
                            className="min-h-[250px] rounded-[2rem] p-8 text-base bg-background/50 border-muted shadow-inner leading-relaxed"
                            placeholder="Tell us your story..."
                            {...field}
                          />
                        </FormControl>
                        <FormDescription className="text-[10px] font-bold italic text-muted-foreground/60">
                          Minimum 10 words, be authentic.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-6 border-2 border-primary/20 p-10 rounded-[2.5rem] bg-primary/5 shadow-xl shadow-primary/[0.02] relative group">
                        ...
                        <div className="space-y-2 leading-tight">
                          <Label className="text-sm font-black text-foreground/90 cursor-pointer block">
                            I certify that all information is true.
                          </Label>
                          <p className="text-[11px] text-muted-foreground font-medium leading-relaxed max-w-md">
                            By electronic signature, you acknowledge that any
                            false information will result in immediate
                            disqualification from the admission cycle.
                          </p>
      ...
      <div className="p-10 md:p-14">
        <div className="flex items-start gap-6 mb-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground font-medium mt-1 leading-relaxed opacity-70">
              {description}
            </p>
          </div>
        </div>
  ...
  return (
    <Card className="border-none shadow-2xl rounded-[2.5rem] bg-card/60 backdrop-blur-xl ring-1 ring-white/10 overflow-hidden">
      <div className="bg-primary/5 px-10 py-5 border-b border-primary/5 flex items-center gap-4">
        ...
        <h3 className="font-black text-[11px] uppercase tracking-[0.25em] text-primary/70">
          {title}
        </h3>
      </div>
...
function PreviewField({ label, value }: { label: string; value: string }) {
  return (
    <div className="space-y-2">
      <Label className="text-[10px] uppercase font-black text-muted-foreground tracking-widest opacity-40">
        {label}
      </Label>
      <p className="font-bold text-[15px] tracking-tight text-foreground/90 break-words">
        {value || "—"}
      </p>
    </div>
  );
