...
const scoreData = [
    ...
    { name: 'Remaining', value: 100 - leadData.score, color: 'hsl(var(--muted)/0.3)' },
];
...
const timelineItems = [
    ...
    },
    {
        ...
        description: "Sent request for original transcripts of undergraduate degree.",
                ...
                <div className="lg:col-span-4 flex flex-col gap-6">
                    <Card className="overflow-hidden border-none shadow-xl shadow-black/5 bg-gradient-to-b from-primary/5 via-background to-background">
                        <CardHeader className="text-center pb-2">
                            ...
                            <CardTitle className="text-2xl font-bold">{leadData.name}</CardTitle>
                        ...
                        <CardContent className="space-y-6">
                            <div className="grid grid-cols-2 gap-2">
                                <Button variant="secondary" className="w-full gap-2 border-primary/10 hover:border-primary/30">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="space-y-0.5">
                                        <p className="text-[10px] font-bold text-muted-foreground uppercase opacity-70">Location</p>
                        ...
                        <CardFooter className="bg-muted/30 border-t py-4">
                            <div className="flex items-center justify-between w-full text-[10px] font-bold uppercase tracking-tighter">
                                ...
                                <div className="text-primary font-black">Source: {leadData.source}</div>
                            </div>
                        </CardFooter>
                    </Card>
                </div>
                ...
                <div className="lg:col-span-8 flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Card className="shadow-lg border-none shadow-black/5 @container/chart">
                            <CardHeader className="pb-2">
                                <CardTitle className="text-lg font-semibold tracking-tight">Lead Score</CardTitle>
                                <CardDescription>High Probability</CardDescription>
                                <CardAction>
                                    <Badge variant="outline" className="font-bold text-[10px] uppercase tracking-wider bg-emerald-500/10 text-emerald-600 border-emerald-500/20 px-2">Hot Lead</Badge>
                                </CardAction>
                            </CardHeader>
                            <CardContent className="flex flex-col items-center justify-center py-4">
                                <div className="relative size-[180px]">
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center pt-8">
                                        <span className="text-4xl font-black text-foreground">{leadData.score}</span>
                                        <span className="text-[10px] font-bold text-muted-foreground uppercase opacity-70 tracking-[0.2em] -mr-[0.2em]">Score</span>
                                    </div>
                                </div>
                                <div className="grid grid-cols-2 w-full gap-4 mt-[-10px]">
                                    <div className="text-center space-y-1">
                                        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-tighter opacity-70">Leads Avg</p>
                                        <p className="text-sm font-bold tracking-tight">78%</p>
                                    </div>
                                    <div className="text-center space-y-1">
                                        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-tighter opacity-70">Response</p>
                                        <p className="text-sm font-bold text-emerald-500 tracking-tight">92%</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="shadow-lg border-none shadow-black/5 bg-gradient-to-br from-background to-primary/[0.02]">
                            <CardHeader className="pb-2">
                                <CardTitle className="text-lg font-semibold tracking-tight">Lead Analysis</CardTitle>
                            ...
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest opacity-70">Current Stage</p>
                                    ...
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest opacity-70">Assigned To</p>
                                        <div className="flex items-center gap-2">
                                            <Avatar className="size-5 border">
                                                <AvatarFallback className="text-[8px] bg-amber-100 text-amber-700 font-bold">RK</AvatarFallback>
                                            </Avatar>
                                            <span className="text-sm font-bold tracking-tight">{leadData.assignedTo}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3 pt-2">
                                    <div className="p-3 rounded-xl bg-muted/30 border border-muted/50 flex flex-col gap-1 ring-1 ring-primary/5">
                                        <p className="text-[10px] font-bold text-muted-foreground uppercase opacity-80 tracking-tighter">Preferred Program</p>
                                        <p className="text-sm font-bold truncate leading-tight">{leadData.program}</p>
                                    ...
                                    <div className="flex items-center justify-between px-1">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[10px] font-bold text-muted-foreground uppercase">High Intent</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <div className="size-2 rounded-full bg-amber-400" />
                                            <span className="text-[10px] font-bold text-muted-foreground uppercase">Review Needed</span>
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
                    ...
                    <Card className="shadow-lg border-none shadow-black/5">
                        <CardHeader className="pb-6">
                            <CardTitle className="text-lg font-semibold tracking-tight">Lead Progression</CardTitle>
                        </CardHeader>
                        <CardContent>
                                ...
                                {stages.map((stage, idx) => {
                                    ...
                                    return (
                                        <div key={stage.name} className="relative z-10 flex flex-col items-center gap-3">
                                            ...
                                            `}>
                                                {isCompleted ? <CheckCircle2 className="size-4" /> : <span className="text-xs font-bold">{idx + 1}</span>}
                                            </div>
                                            <div className="flex flex-col items-center">
                                                <span className={`text-[9px] font-black uppercase tracking-tighter ${isCurrent ? 'text-primary' : 'text-muted-foreground opacity-60'}`}>
                                                    {stage.name}
                                                </span>
                                                {isCurrent && (
                                                    <span className="text-[7px] font-bold text-primary italic leading-none mt-0.5">Focus</span>
                                                )}
                                            </div>
                                        </div>
                                    );
                    ...
                    <Card className="shadow-lg border-none shadow-black/5 flex-1 min-h-[400px]">
                        <CardHeader className="flex flex-row items-center justify-between pb-6">
                            <div>
                                <CardTitle className="text-lg font-semibold tracking-tight">Timeline & Interactions</CardTitle>
                                <CardDescription className="text-xs">History of all lead touchpoints</CardDescription>
                            </div>
                            <div className="flex items-center gap-2">
                            ...
                            <ScrollArea className="h-[450px] pr-4">
                                <div className="relative space-y-8 ml-6 before:absolute before:inset-y-0 before:left-[-20px] before:w-[2px] before:bg-gradient-to-b before:from-primary/40 before:via-muted before:to-transparent">
                                        ...
                                        <div key={idx} className="relative group">
                                            ...
                                            <div className="p-4 rounded-2xl bg-muted/20 border border-transparent hover:border-primary/5 hover:bg-muted/30 transition-all duration-300 shadow-sm hover:shadow-md">
                                                <div className="flex justify-between items-start mb-1">
                                                    <h5 className="text-sm font-bold tracking-tight text-foreground/90">{item.title}</h5>
                                                    <time className="text-[9px] font-black text-muted-foreground opacity-50 uppercase tracking-widest">{item.time}</time>
                                                </div>
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-2">
                                                        <span className="text-[9px] font-bold text-muted-foreground uppercase opacity-50">Handled by</span>
                                                        <div className="flex items-center gap-1.5">
                                                            <Avatar className="size-4 border">
                                                                <AvatarFallback className="text-[6px] bg-primary/10 text-primary font-black uppercase">{item.user[0]}</AvatarFallback>
                                                            </Avatar>
                                                            <span className="text-[10px] font-bold tracking-tight uppercase opacity-80">{item.user}</span>
                                                        </div>
                                                    </div>
                                                    <Button variant="ghost" size="sm" className="h-6 text-[10px] font-black px-2 hover:bg-primary/5 text-primary uppercase tracking-widest">
                                    ...
                                    <div className="flex items-center justify-center pt-4">
                                        <Button variant="ghost" size="sm" className="text-[10px] font-black text-muted-foreground hover:text-primary gap-2 uppercase tracking-widest">
