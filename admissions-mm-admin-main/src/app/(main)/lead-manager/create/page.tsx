      ...
      <div className="px-4 md:px-6 py-4 md:py-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                  <div className="flex flex-col gap-2">
                    ...
                    <Select value={form.state} onValueChange={(v) => set("state", v)}>
                      <SelectTrigger id="state" className="border border-input h-[40px] rounded-[8px] text-[12px] text-foreground w-full data-[placeholder]:text-foreground">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            {/* CRM Detail Card */}
            <div className="border border-border rounded-[8px] bg-card p-6 flex flex-col gap-6" data-node-id="77:1671">
              <h2 className="text-[18px] font-medium text-foreground" data-node-id="77:1672">
                CRM Detail
              </h2>
              ...
              <div className="flex flex-col gap-5">
                {/* Source */}
                <div className="flex flex-col gap-2">
                  <Label htmlFor="crm-source" className="text-[14px] font-semibold uppercase tracking-[0.6px] text-muted-foreground">Source</Label>
                  <Select value={form.source} onValueChange={(v) => set("source", v)}>
                    <SelectTrigger id="crm-source" className="border border-input h-[40px] rounded-[8px] text-[12px] text-foreground w-full data-[placeholder]:text-foreground">
                      <SelectValue placeholder="Select Source" />
                    </SelectTrigger>
                    <SelectContent>
                      {SOURCES.map((s) => (
                ...
                {/* Medium */}
                <div className="flex flex-col gap-2">
                  <Label htmlFor="crm-medium" className="text-[14px] font-semibold uppercase tracking-[0.6px] text-muted-foreground">Medium</Label>
                  <Select value={form.medium} onValueChange={(v) => set("medium", v)}>
                    <SelectTrigger id="crm-medium" className="border border-input h-[40px] rounded-[8px] text-[12px] text-foreground w-full data-[placeholder]:text-foreground">
                      <SelectValue placeholder="Select Medium" />
                    </SelectTrigger>
                    <SelectContent>
                      {MEDIUMS.map((m) => (
                ...
                {/* Campaign */}
                <div className="flex flex-col gap-2">
                  <Label htmlFor="crm-campaign" className="text-[14px] font-semibold uppercase tracking-[0.6px] text-muted-foreground">Campaign</Label>
                  <Select value={form.campaign} onValueChange={(v) => set("campaign", v)}>
                    <SelectTrigger id="crm-campaign" className="border border-input h-[40px] rounded-[8px] text-[12px] text-foreground w-full data-[placeholder]:text-foreground">
                      <SelectValue placeholder="Select Campaign" />
                    </SelectTrigger>
                    <SelectContent>
                      {CAMPAIGNS.map((c) => (
            ...
            {/* Protip Card */}
            <div className="bg-accent flex flex-col gap-4 p-6 rounded-[8px]" data-node-id="77:1718">
